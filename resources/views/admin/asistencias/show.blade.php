                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <a href="{{ route('admin.estudiantes.show', $asistencia->estudiante->id) }}" class="btn btn-info">
                                    <i class="fas fa-user-graduate"></i> Ver Perfil del Estudiante
                                </a>
                                <a href="{{ route('admin.cursos.show', $asistencia->curso->id) }}" class="btn btn-primary">
                                    <i class="fas fa-book"></i> Ver Detalles del Curso
                                </a>
                                @if($asistencia->docente)
                                <a href="{{ route('admin.docentes.show', $asistencia->docente->id) }}" class="btn btn-success">
