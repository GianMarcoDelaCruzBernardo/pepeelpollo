                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group">
                                        <a href="{{ route('admin.asistencias.show', $asistencia->id) }}" 
                            ...
                            <div class="modal fade" id="deleteAsistenciaModal{{ $asistencia->id }}" tabindex="-1" role="dialog">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('admin.asistencias.destroy', $asistencia->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <div class="modal-body">
                ...
                <form action="{{ route('admin.asistencias.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="docente_id_create">Docente</label>
    ...
    <div class="modal fade" id="registroMasivoModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.asistencias.registro-masivo') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="alert alert-info">
