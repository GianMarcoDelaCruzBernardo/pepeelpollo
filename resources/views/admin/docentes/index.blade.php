                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="codigo_docente_create" value="{{ old('codigo_docente_create') }}"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="especialidad_create" value="{{ old('especialidad_create') }}"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="fecha_contratacion_create" value="{{ old('fecha_contratacion_create') }}"
                                        class="form-control" required>
                                    <small style="color:red">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <form action="{{ route('admin.docentes.update', $docente->id) }}" method="POST">
                        ...
                        @method('PUT')
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="editDocenteModalLabel{{ $docente->id }}">Editar Docente</h1>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        </div>
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="">Apellidos <b>*</b></label>
                                        <input type="text" name="apellidos" value="{{ $docente->persona->apellidos }}"
                                            class="form-control" required maxlength="100">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="">Fecha de Nacimiento <b>*</b></label>
                                        <input type="date" name="fecha_nacimiento" value="{{ $docente->persona->fecha_nacimiento }}"
                                            class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="">Dirección</label>
                                        <input type="text" name="direccion" value="{{ $docente->persona->direccion }}"
                                            class="form-control" maxlength="255">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="">Teléfono Emergencia</label>
                                        <input type="text" name="telefono_emergencia" value="{{ $docente->persona->telefono_emergencia }}"
                                            class="form-control" maxlength="20">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="">Fecha Contratación <b>*</b></label>
                                        <input type="date" name="fecha_contratacion" value="{{ $docente->fecha_contratacion }}"
                                            class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-md-3">
