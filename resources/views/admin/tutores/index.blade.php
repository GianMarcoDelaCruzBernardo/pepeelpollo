...
@section('content')
    ...
    <!-- Modal CREATE-->
    <div class="modal fade" id="createTutorModal" tabindex="-1" aria-labelledby="createTutorModalLabel"
        aria-hidden="true">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="codigo_tutor_create" value="{{ old('codigo_tutor_create') }}"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <form action="{{ route('admin.tutores.update', $tutor->id) }}" method="POST">
                        ...
                        @method('PUT')
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="editTutorModalLabel{{ $tutor->id }}">Editar Tutor</h1>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="">DNI <b>*</b></label>
                                        <input type="text" name="dni" value="{{ $tutor->persona->dni }}"
                                            class="form-control" required maxlength="20">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="">Nombres <b>*</b></label>
                                        <input type="text" name="nombres" value="{{ $tutor->persona->nombres }}"
                                            class="form-control" required maxlength="100">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="">Apellidos <b>*</b></label>
                                        <input type="text" name="apellidos" value="{{ $tutor->persona->apellidos }}"
                                            class="form-control" required maxlength="100">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="">Fecha de Nacimiento <b>*</b></label>
                                        <input type="date" name="fecha_nacimiento" value="{{ $tutor->persona->fecha_nacimiento }}"
                                            class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="estado" class="form-select" required>
                                            <option value="Activo" {{ $tutor->persona->estado == 'Activo' ? 'selected' : '' }}>Activo</option>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="">Dirección</label>
                                        <input type="text" name="direccion" value="{{ $tutor->persona->direccion }}"
                                            class="form-control" maxlength="255">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="">Teléfono</label>
                                        <input type="text" name="telefono" value="{{ $tutor->persona->telefono }}"
                                            class="form-control" maxlength="20">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="">Teléfono Emergencia</label>
                                        <input type="text" name="telefono_emergencia" value="{{ $tutor->persona->telefono_emergencia }}"
                                            class="form-control" maxlength="20">
                                    </div>
                                </div>
                            </div>
