                        ...
                        <tbody>
                            ...
                            @foreach ($estudiantes as $estudiante)
                                <tr>
                                    ...
                                    <td>{{ $estudiante->tutor_principal ? $estudiante->tutor_principal->nombre_completo : 'Sin tutor' }}</td>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="fecha_nacimiento_create" value="{{ old('fecha_nacimiento_create') }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="telefono_emergencia_create" value="{{ old('telefono_emergencia_create') }}"
                                        class="form-control" maxlength="20">
                                    <small style="color:red">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="codigo_estudiante_create" value="{{ old('codigo_estudiante_create') }}"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="año_ingreso_create" value="{{ old('año_ingreso_create', date('Y')) }}"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="condicion_create" class="form-select" required>
                                        <option value="">Seleccione...</option>
                                        <option value="Regular" {{ old('condicion_create') == 'Regular' ? 'selected' : '' }}>Regular</option>
                                        <option value="Irregular" {{ old('condicion_create') == 'Irregular' ? 'selected' : '' }}>Irregular</option>
                                        <option value="Retirado" {{ old('condicion_create') == 'Retirado' ? 'selected' : '' }}>Retirado</option>
                                    </select>
                                    <small style="color:red">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <form action="{{ route('admin.estudiantes.update', $estudiante->id) }}" method="POST">
                        ...
                        @method('PUT')
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="editEstudianteModalLabel{{ $estudiante->id }}">Editar Estudiante</h1>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="">Fecha de Nacimiento <b>*</b></label>
                                        <input type="date" name="fecha_nacimiento" value="{{ $estudiante->persona->fecha_nacimiento }}"
                                            class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="">Dirección</label>
                                        <input type="text" name="direccion" value="{{ $estudiante->persona->direccion }}"
                                            class="form-control" maxlength="255">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="">Teléfono</label>
                                        <input type="text" name="telefono" value="{{ $estudiante->persona->telefono }}"
                                            class="form-control" maxlength="20">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="">Teléfono Emergencia</label>
                                        <input type="text" name="telefono_emergencia" value="{{ $estudiante->persona->telefono_emergencia }}"
                                            class="form-control" maxlength="20">
                                    </div>
                                </div>
                            </div>
