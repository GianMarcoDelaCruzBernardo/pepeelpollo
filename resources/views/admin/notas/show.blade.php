            ...
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <div class="form-group">
                                <a href="{{ route('admin.notas.index') }}" class="btn btn-secondary">
                                    <i class="fas fa-arrow-left"></i> Volver al Listado
                                </a>
                                <a href="{{ route('admin.estudiantes.show', $nota->matricula->estudiante->id) }}" class="btn btn-info">
                                    <i class="fas fa-user-graduate"></i> Ver Perfil del Estudiante
                                </a>
                                <a href="{{ route('admin.cursos.show', $nota->matricula->curso->id) }}" class="btn btn-primary">
                                    <i class="fas fa-book"></i> Ver Detalles del Curso
                                </a>
                                <a href="{{ route('admin.docentes.show', $nota->docente->id) }}" class="btn btn-success">
                                    <i class="fas fa-chalkboard-teacher"></i> Ver Perfil del Docente
                                </a>
                                @if(!$nota->visible_tutor)
                                <form action="{{ route('admin.notas.publicar', $nota->id) }}" method="POST" style="display: inline-block;">
                                    @csrf
                                ...
                                @else
                                <form action="{{ route('admin.notas.despublicar', $nota->id) }}" method="POST" style="display: inline-block;">
                                    @csrf
