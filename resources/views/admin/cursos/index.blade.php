                ...
                <form action="{{ route('admin.cursos.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="creditos_create">Créditos <span class="text-danger">*</span></label>
                                    <input type="number" 
                                           name="creditos_create" 
                                           class="form-control @error('creditos_create') is-invalid @enderror" 
                                           value="{{ old('creditos_create', 3) }}" 
                                           min="1" 
                                           max="20" 
                                           required>
                                    @error('creditos_create')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                    <small class="form-text text-muted">Entre 1 y 20 créditos</small>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            @if($errors->has('nombre_create') || $errors->has('codigo_create') || $errors->has('creditos_create') || $errors->has('horas_semanales_create') || $errors->has('nivel_id_create'))
