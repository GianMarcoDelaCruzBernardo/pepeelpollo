                        ...
                        <div class="form-group">
                            ...
                            <select name="gestion_id" class="form-control">
                                ...
                                @foreach($gestiones as $gestion)
                                    <option value="{{ $gestion->id }}" {{ request('gestion_id') == $gestion->id ? 'selected' : '' }}>
                                        {{ $gestion->año }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select name="tipo" class="form-control">
                                <option value="">Todos</option>
                                <option value="Bimestral" {{ request('tipo') == 'Bimestral' ? 'selected' : '' }}>Bimestral</option>
        ...
        <div class="col-md-12">
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#createReporteModal">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <strong>{{ $reporte->estudiante->persona->apellidos }}, {{ $reporte->estudiante->persona->nombres }}</strong>
                                </td>
                                <td>
                                ...
                                <td class="text-center">
                                    @if($reporte->tienePdf())
                                        <a href="{{ route('admin.reportes.descargar-pdf', $reporte->id) }}" 
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group">
                                        ...
                                        <button type="button" 
                                                ...
                                                data-toggle="modal" 
                                                data-target="#editReporteModal{{ $reporte->id }}"
                                                title="Editar">
                                        ...
                                        <button type="button" 
                                                ...
                                                data-toggle="modal" 
                                                data-target="#deleteReporteModal{{ $reporte->id }}"
                                                title="Eliminar">
                            ...
                            <!-- Modal Editar -->
                            <div class="modal fade" id="editReporteModal{{ $reporte->id }}" tabindex="-1" role="dialog">
                                <div class="modal-dialog modal-xl" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('admin.reportes.update', $reporte->id) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="estudiante_id" class="form-control select2" required>
                                                                @foreach($estudiantes as $estudiante)
                                                                    <option value="{{ $estudiante->id }}" {{ old('estudiante_id', $reporte->estudiante_id) == $estudiante->id ? 'selected' : '' }}>
                                                                        {{ $estudiante->persona->apellidos }}, {{ $estudiante->persona->nombres }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="docente_id" class="form-control select2" required>
                                                                @foreach($docentes as $docente)
                                                                    <option value="{{ $docente->id }}" {{ old('docente_id', $reporte->docente_id) == $docente->id ? 'selected' : '' }}>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="tipo" class="form-control" required>
                                                                <option value="Bimestral" {{ old('tipo', $reporte->tipo) == 'Bimestral' ? 'selected' : '' }}>Bimestral</option>
                                                                <option value="Trimestral" {{ old('tipo', $reporte->tipo) == 'Trimestral' ? 'selected' : '' }}>Trimestral</option>
                                                                <option value="Anual" {{ old('tipo', $reporte->tipo) == 'Anual' ? 'selected' : '' }}>Anual</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="periodo_id" class="form-control" required>
                                                                @foreach($periodos as $periodo)
                                                                    <option value="{{ $periodo->id }}" {{ old('periodo_id', $reporte->periodo_id) == $periodo->id ? 'selected' : '' }}>
                                                                        {{ $periodo->nombre }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="gestion_id" class="form-control" required>
                                                                @foreach($gestiones as $gestion)
                                                                    <option value="{{ $gestion->id }}" {{ old('gestion_id', $reporte->gestion_id) == $gestion->id ? 'selected' : '' }}>
                                                                        {{ $gestion->año }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="custom-control custom-checkbox">
                                                                ...
                                                                <label class="custom-control-label" for="visible_tutor{{ $reporte->id }}">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="comentario_final" class="form-control" rows="3" 
                                                                      maxlength="2000">{{ old('comentario_final', $reporte->comentario_final) }}</textarea>
                            ...
                            <!-- Modal Eliminar -->
                            <div class="modal fade" id="deleteReporteModal{{ $reporte->id }}" tabindex="-1" role="dialog">
                                        ...
                                        <form action="{{ route('admin.reportes.destroy', $reporte->id) }}" method="POST">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="alert alert-info">
                                                    <strong>Estudiante:</strong> {{ $reporte->estudiante->persona->nombres }} {{ $reporte->estudiante->persona->apellidos }}<br>
                                                    <strong>Tipo:</strong> {{ $reporte->tipo }}<br>
                                                    <strong>Periodo:</strong> {{ $reporte->periodo->nombre }}<br>
                                                    <strong>Promedio:</strong> {{ $reporte->promedio_general ?? 'N/A' }}
                                                </div>
                                                @if($reporte->tienePdf())
    ...
    <div class="modal fade" id="createReporteModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.reportes.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="alert alert-info">
                            <i class="fas fa-info-circle"></i>
                            <strong>Tip:</strong> Puedes dejar el promedio y asistencia en blanco y usar el botón "Calcular Automáticamente" después de crear el reporte.
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="tipo_create" class="form-control" required>
                                        <option value="Bimestral" {{ old('tipo_create', 'Bimestral') == 'Bimestral' ? 'selected' : '' }}>Bimestral</option>
                                        <option value="Trimestral" {{ old('tipo_create') == 'Trimestral' ? 'selected' : '' }}>Trimestral</option>
                                        <option value="Anual" {{ old('tipo_create') == 'Anual' ? 'selected' : '' }}>Anual</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="promedio_general_create" class="form-control" 
                                           step="0.01" min="0" max="20" 
                                           value="{{ old('promedio_general_create') }}"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="porcentaje_asistencia_create" class="form-control" 
                                           step="0.01" min="0" max="100" 
                                           value="{{ old('porcentaje_asistencia_create') }}"
                                           placeholder="Opcional">
                                    <small class="text-muted">Dejar vacío para calcular después</small>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Comentario Final del Docente</label>
                                    <textarea name="comentario_final_create" class="form-control" rows="3" 
                                              maxlength="2000" 
