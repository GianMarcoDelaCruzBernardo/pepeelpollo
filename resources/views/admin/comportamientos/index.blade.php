...
@section('content')
    ...
    <div class="card card-outline card-info collapsed-card">
        ...
        <div class="card-body">
            <form action="{{ route('admin.comportamientos.index') }}" method="GET">
                <div class="row">
                    <div class="col-md-3">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group">
                                        <a href="{{ route('admin.comportamientos.show', $comportamiento->id) }}" 
                            ...
                            <div class="modal fade" id="editComportamientoModal{{ $comportamiento->id }}" tabindex="-1" role="dialog">
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('admin.comportamientos.update', $comportamiento->id) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                            ...
                            <div class="modal fade" id="deleteComportamientoModal{{ $comportamiento->id }}" tabindex="-1" role="dialog">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('admin.comportamientos.destroy', $comportamiento->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <div class="modal-body">
    ...
    <div class="modal fade" id="createComportamientoModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.comportamientos.store') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
