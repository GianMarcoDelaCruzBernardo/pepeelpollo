...
class User extends Authenticatable
{
    ...
    {
        if ($this->persona) {
            if ($this->persona->administrador) return 'Administrador';
            if ($this->persona->docente) return 'Docente';
            if ($this->persona->estudiante) return 'Estudiante';
            if ($this->persona->tutor) return 'Tutor';
        }
        
        // Verificar por rol si no tiene persona específica
        if ($this->tieneRol('administrador')) return 'Administrador';
