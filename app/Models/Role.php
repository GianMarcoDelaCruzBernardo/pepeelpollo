...
class Role extends Model
{
    ...
    public static function obtenerEstadisticas()
    {
        return [
            ...
            'total_usuarios_asignados' => \App\Models\User::with('roles')->get()->pluck('roles')->flatten()->count(),
            'total_permisos_asignados' => \App\Models\Permission::with('roles')->get()->pluck('roles')->flatten()->count(),
