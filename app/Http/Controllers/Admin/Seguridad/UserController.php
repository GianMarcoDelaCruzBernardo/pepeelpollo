...
class UserController extends Controller
{
    ...
    {
        $usuario = User::with(['persona', 'roles.permissions', 'notificaciones', 'mensajesEnviados', 'mensajesRecibidos'])
                       ->findOrFail($id);
        
        // Obtener todos los roles
        $todosLosRoles = Role::all();
        
        // Obtener todas las personas sin usuario
        $personasSinUsuario = Persona::whereNull('user_id')
                                     ->where('estado', 'Activo')
                                     ->get();
        
        // Si el usuario tiene persona, agregarla a la lista
        if ($usuario->persona) {
