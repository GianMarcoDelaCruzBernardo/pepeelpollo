...
class CursoController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'creditos_create' => 'required|integer|min:1|max:20',
            ...
            'creditos_create.required' => 'Los créditos son obligatorios.',
            'creditos_create.integer' => 'Los créditos deben ser un número entero.',
            'creditos_create.min' => 'Los créditos deben ser al menos 1.',
        ...
        try {
            ...
            $curso->creditos = $request->creditos_create;
